...
if __name__=="__main__":
    ...
    train_set_x, train_set_y = load_dataset('./mlee/train',is_train=1)
    ...
    with open('data/y_train', 'w') as f:
        ...
        f.flush()
        f.close()
    print "*"*20+'validining'+'*'*20
    valid_set_x, valid_set_y = load_dataset('./mlee/valid',is_train=1)
    with open('data/X_valid', 'w') as f:
		pickle.dump(valid_set_x, f)
		f.flush()
		f.close()
    with open('data/y_valid', 'w') as f:
		pickle.dump(valid_set_y, f)
		f.flush()
		f.close()
    print "*"*20+'testing'+'*'*20
    test_set_x, test_set_y = load_dataset('./mlee/test',is_train=0)
